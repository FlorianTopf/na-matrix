...
--
-- Host: localhost
-- Generation Time: Sep 06, 2011 at 02:04 PM
...
(44, 'Mercury Surface, Space Environment, Geochemistry and Ranging (MESSENGER)', 'NASA', '2004-08-03', '0000-00-00', '', 'Mercury.', 9),
...
(36, 'SOHO', 'NASA', '0000-00-00', '0000-00-00', 'http://sohowww.nascom.nasa.gov/about/orbit.html', 'ESA', 21),
(37, 'Venus Express', 'ESA', '2005-11-09', '2012-12-31', 'http://sci.esa.int/science-e/www/object/index.cfm?fobjectid=37357', '', 22),
(38, 'XMM-Newton', 'ESA', '1999-12-10', '2012-00-00', 'http://sci.esa.int/science-e/www/object/index.cfm?fobjectid=31349', 'Earth Orbit', 23),
...
(380, 'MASCS (Mercury Atmospheric and Surface Composition Spectrometer', '', 'Visible and Infrared Spectrograph [VIS] Silicon and Indium-Gallium-Arsenide-Infrared photodiode arrays', 300.00, 1450.00, 'nm', 'Mercury Surface Composition,,', 'Spectra 5nm resolution, Mineralogical composition 5km scale', '  x  ', 'SP', 'William?E.?McClintock', 'william.mcclintock@lasp.colorado.edu', 9),
(381, 'EPPS', 'Spectrometer', 'Enegetic Particle Spectrometer [EPS]', 0.02, 3.00, 'MeV', 'H, He, CNO', '', '160  x  12', '', 'Bruce Andrews', 'Bruce.Andrews@jhuapl.edu', 9),
(382, 'EPPS', 'Spectrometer', 'Fast Imaging Plasma Spectrometer [FIPS]', 50.00, 20000.00, 'eV', 'energy, angular, and compositional distributions of the low-energy components of the ion distributions', 'delE/E = 10%', '1.4 pi steradians  x  ', '', 'Bruce Andrews', 'Bruce.Andrews@jhuapl.edu', 9),
(379, 'MASCS (Mercury Atmospheric and Surface Composition Spectrometer)', 'Spectrometer', 'Ultra Violet and Visible Spectrometer [UVVS]', 115.00, 600.00, 'nm', 'Mercury''s Exosphere,,', 'Spectral resolution 0.6nm', '  x  ', 'AU, SP', 'William?E.?McClintock', 'william.mcclintock@lasp.colorado.edu', 9),
(378, 'MLA (Mercury Laser Alitmeter)', 'Altimeter', 'Time-of-flight laser rangefinder', NULL, 1200.00, 'km nadir', 'Mercury''s High Northern Latitudes,,', '1m', '400&#956;rad full angle, circular  x  ', 'SP', 'John Cavanaugh', 'john.f.cavanaugh@nasa.gov', 9),
(377, 'MAG (Magnetometer)', 'Magnetometer', 'Tri-axial Fluxgate', -51300.00, 51300.00, 'nT', 'Mercury''s intrinsic magnetic field,,', '1.6nT (coarse) and 0.047nT (fine)', '  x  ', 'MA', 'James Slavin', 'james.a.slavin@nasa.gov', 9),
(376, 'XRS (X-Ray Spectrometer)', 'Spectrometer', '3 Gas detectors, 1 Silicon detector', 1.00, 10.00, 'keV', 'Mg,Al,Si', 'Spatial, 42km - 3200km', '12?  x  12?', 'SP', 'C. Schlemm', 'chuck.schlemm@jhuapl.edu', 9),
(375, 'GRNS (Gamma Ray and Neutron Spectrometer)', 'Spectrometer', 'Germanium Coaxial Detector, Li-glass and borated plastic scintillators', 0.10, 10.00, 'MeV', 'H, O, Na', '&#8776;3.5 keV at FWHM, >5000 events per second, For the spectrometer Energy resolution &#8776;50% for Li-glass and &#8776;30% for the borated plastic scintillator >10,000 events per second', 'For Neutrons, 10cm  x  10cm ', 'SP', 'J. Goldsten', 'john.goldsten@jhuapl.edu', 9),
(374, 'MDIS (Mercury Dual Imaging System)', 'Imager', 'CCD Detectors', 350.00, 1110.00, 'nm', 'Visible and near Infrared light (up to 1100nm),,', '1024 x 1024 pixel array, 14&#956;m pixels', 'Narrow 1.5?, Wide 10.5?  x  ', 'SP', 'S. E. Hawkins', 'ed.hawkins@jhuapl.edu', 9),
...
(327, 'CDS', 'Spectrometer', 'Coronal Diagnostic Spectrometer', NULL, NULL, '', 'Electron number density,,', '', ' x ', '', 'Dr Andrzej Fludra', 'fludra@cdso8.nascom.nasa.gov', 21),
(328, 'CELIAS (Charge, Element and Isotope Analysis System)', '', 'solar extreme ultraviolet monitor', NULL, NULL, '', 'mass, ionic charge,energy of solar wind, suprathermal ions and low energy flare particles', '', ' x ', '', 'Martin Hilchenbach', 'http://www.space.unibe.ch/soho/celias_team.html', 21),
(329, 'COSTEP (Comprehensive Suprathermal and Energetic Particle Analyzer)', '', 'Telescope and semiconductor detectors', 0.04, 26.00, 'MeV', 'protons,electrons,alpha', '', '60 x 40 deg', '', 'Dr Bernd Heber', 'heber@physik.uni-kiel.de', 21),
(330, 'EIT (Extreme Ultraviolet Imaging Telescope)', 'Telescope', 'Telescope', 17.10, 30.40, 'nm', ',,', '', '45 x 45 arcminutes', '', 'Joe Gurman', 'gurman@gsfc.nasa.gov', 21),
(331, 'ERNE (Energetic and Relativistic Nuclei and Electron Experiment )', '', '', 2.00, 50.00, 'MeV', ',,', '', ' x ', '', 'Eino Valtonen', 'eino.valtonen@utu.fi', 21),
(332, 'GOLF (Global Oscillations of Low Frequencies )', '', '', NULL, NULL, '', ',,', '', ' x ', '', 'Alan Gabriel', '', 21),
(333, 'LASCO (Large Angle and Spectrometric Coronagraph)', 'Interferometer', 'Fabry-Perot Interferometer', 1.10, 30.00, 'Solar Radii', ',,', '1 megapixel', ' x ', '', '', '', 21),
(334, 'MDI (Michelson Doppler Imager)', 'Imager', 'Interferometer', NULL, NULL, '', ',,', '', ' x ', '', 'Philip H Scherrer', '', 21),
(335, 'SUMER (Solar Ultraviolet Measurements of Emitted Radiation)', '', '', NULL, NULL, '', ',,', '', ' x ', '', 'Werner Curdt', '', 21),
(336, 'SWAN (Solar Wind Anisotropies)', '', '', NULL, NULL, '', ',,', '', ' x ', '', 'Jean-Loup Berteaux', '', 21),
(337, 'UVCS (Ultraviolet Coronagraph Spectrometer)', 'Spectrometer', '', NULL, NULL, '', ',,', '', ' x ', '', 'John L Kohl', '', 21),
(338, 'VIRGO (Variability of Solar Irradiance and Gravity Oscillations)', '', '', NULL, NULL, '', ',,', '', ' x ', '', 'K Frohlich', '', 21),
...
(346, 'EPIC (European Photon Imaging Camera)', 'Camera', 'Metal Oxide Semi conductors ', 0.15, 15.00, 'KeV', 'Photons from radiative belts and solar flares,,', '6 arcseconds', '30 x 30 arcseconds', '', 'Dr Steven Sembay', 'sfs5@star.le.ac.uk', 23),
(347, 'RGS (Reflection Grating Spectrometer)', 'Spectrometer', 'Spectrometer', 0.33, 2.50, 'KeV', 'X-rays,,', '', ' x ', '', '', '', 23),
(348, 'OM (Optical/UV Monitor)', 'telescope', 'UV optical telescope', 170.00, 550.00, 'nm', 'Ultraviolet Wavelengths,,', '', '24 x 24 arcminutes', '', 'Keith Mason', 'rs1@mssl.ucl.ac.uk', 23),
